...
```
cd existing_repo
git remote add origin https://gitlab-stud.elka.pw.edu.pl/mgryglic/restaurant.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-stud.elka.pw.edu.pl/mgryglic/restaurant/-/settings/integrations)
